...
public record GuideToolMessage(Key key, List<String> arguments) {
    public enum Key {
        ...
        INVOCATION_RESOURCE_LIST("screen.openallay.tool.message.invocation.resource_list"),
        INVOCATION_RESOURCE_READ("screen.openallay.tool.message.invocation.resource_read"),
        INVOCATION_RESOURCE_GLOB("screen.openallay.tool.message.invocation.resource_glob"),
        INVOCATION_RESOURCE_GREP("screen.openallay.tool.message.invocation.resource_grep"),
        INVOCATION_RESOURCE_QUERY("screen.openallay.tool.message.invocation.resource_query"),
        ...
        RESOURCE_RESULT_SUMMARY("screen.openallay.tool.message.resource.summary"),
        RESOURCE_RESULT_PATH("screen.openallay.tool.message.resource.result_path"),
        RESOURCE_RESULT_CONTINUATION("screen.openallay.tool.message.resource.continuation"),
