...
public record ToolSettingsView(List<Family> families) {
    ...
    private static Member member(
        ...
        String fallbackKey = "settings.openallay.capability.tool."
    ...
    private static String titleKey(ToolFamilyId id) {
        return "openallay.settings.tools." + keySegment(id) + ".title";
    }

    private static String descriptionKey(ToolFamilyId id) {
        return "openallay.settings.tools." + keySegment(id) + ".description";
    }
