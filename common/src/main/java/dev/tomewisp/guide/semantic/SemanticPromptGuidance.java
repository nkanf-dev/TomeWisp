...
public final class SemanticPromptGuidance {
    ...
    public static String text() {
        ...
        return """
                ...
                Controlled components use one fenced tomewisp-component JSON object with exactly these envelope fields:
                ...
                A recipe_grid must copy the complete exact recipe handle from the same request's Tool result. Never author slots, coordinates, textures, widget names, or a recipe layout; TomeWisp binds the handle to trusted native recipe data.
