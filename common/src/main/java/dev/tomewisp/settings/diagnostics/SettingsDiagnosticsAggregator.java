...
import dev.tomewisp.settings.diagnostics.SettingsDiagnosticCard.Domain;
import dev.tomewisp.settings.diagnostics.SettingsDiagnosticCard.FriendlyStatus;
import dev.tomewisp.settings.diagnostics.SettingsDiagnosticCard.Metric;
...
import dev.tomewisp.settings.diagnostics.SettingsDiagnosticsSnapshot.DebugSource;
...
public final class SettingsDiagnosticsAggregator {
    ...
    private static SettingsDiagnosticCard modelCard(ModelProfileSettingsView models) {
        ...
        return card(Domain.MODELS, status, List.of(
                metric("screen.tomewisp.settings.diagnostics.metric.configured", total),
                metric("screen.tomewisp.settings.diagnostics.metric.available", available),
                metric("screen.tomewisp.settings.diagnostics.metric.credentials", credentials)));
    }
    ...
    private static SettingsDiagnosticCard knowledgeCard(
        ...
        return card(Domain.KNOWLEDGE, status, List.of(
                metric("screen.tomewisp.settings.diagnostics.metric.registered", catalog),
                metric("screen.tomewisp.settings.diagnostics.metric.enabled", enabled),
                metric("screen.tomewisp.settings.diagnostics.metric.sources", sources.size()),
                metric("screen.tomewisp.settings.diagnostics.metric.available_sources", availableSources)));
    }
    ...
    private static SettingsDiagnosticCard contextCard(
        ...
        return card(Domain.CONTEXT, status, List.of(
                metric("screen.tomewisp.settings.diagnostics.metric.checkpoints",
                        guide.checkpointCount()),
                metric("screen.tomewisp.settings.diagnostics.metric.checkpoint_failures",
                        guide.failedCheckpoints()),
                metric("screen.tomewisp.settings.diagnostics.metric.estimated_tokens",
