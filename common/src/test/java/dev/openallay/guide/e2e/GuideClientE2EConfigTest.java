...
final class GuideClientE2EConfigTest {
    ...
    void parsesExplicitHarnessContract() {
        ...
        properties.setProperty("openallay.e2e.question", "Can I craft this?");
        properties.setProperty("openallay.e2e.report", "build/e2e/report.json");
        properties.setProperty("openallay.e2e.modelMode", "server");
        properties.setProperty("openallay.e2e.shutdown", "false");
        properties.setProperty("openallay.e2e.historySeedRequests", "12");
