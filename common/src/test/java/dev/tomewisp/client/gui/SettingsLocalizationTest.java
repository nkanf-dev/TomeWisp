...
final class SettingsLocalizationTest {
    private static final Set<String> REQUIRED = Set.of(
            ...
            "screen.tomewisp.model.client",
            "screen.tomewisp.model.server",
            ...
            "screen.tomewisp.settings.models.fetch",
            "screen.tomewisp.settings.models.choose",
            "screen.tomewisp.settings.models.catalog_title",
            "screen.tomewisp.settings.models.catalog_empty",
            "screen.tomewisp.settings.models.catalog_invalid",
