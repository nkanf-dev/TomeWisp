...
- [x] **Step 1: Write failing scalar, record, collection, map, Optional, enum, temporal, and JsonElement tests**
...
- [x] **Step 2: Write failing immutability and host-denial tests**
...
- [x] **Step 3: Implement accepted-value dispatch**
...
- [x] **Step 4: Implement lazy read-only Scriptable views**
...
- [x] **Step 1: Write lazy-root tests**
...
- [x] **Step 2: Implement root descriptors**
...
- [x] **Step 4: Run focused graph tests**
...
- [x] **Step 1: Add a no-serialization regression test**
...
- [x] **Step 2: Change the runtime signature**
...
- [x] **Step 5: Preserve deadline and normalization**
...
- [x] **Step 1: Write request-cache and extension-record tests**
...
- [x] **Step 2: Make workspace selection direct**
...
- [x] **Step 3: Cache `MinecraftAgentHostGraph` in `RunJavascriptTool`**
...
- [x] **Step 4: Upgrade extension snapshots**
...
- [x] **Step 5: Run tool/extension/workspace tests**
...
- [x] **Step 2: Update prompt and Skill terminology**
...
- [x] **Step 1: Run all common tests and both loader builds**
...
- [x] **Step 2: Run opt-in live Agent acceptance**
